<?php
/**
 * Fix 2FA Issue via File Manager
 * 
 * INSTRUCTIONS:
 * 1. Download this file
 * 2. Upload it to: wp-content/themes/twentytwentyfive/
 * 3. Rename it to: functions.php (backup the original first!)
 * 4. Or add this code to the existing functions.php file
 */

// This is the code to add to your theme's functions.php file
// It will remove the 2FA message that's being injected client-side
...
error_log('2FA Message Remover: Active and loaded');
?>
