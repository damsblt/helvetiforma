<?php
/**
 * Plugin Name: HelvetiForma Premium Automation
 * Description: Crée automatiquement des produits WooCommerce pour les articles premium
 * Version: 1.0.0
 * Author: HelvetiForma
 */
...
class HelvetiForma_Premium_Automation {
    ...
    private function create_woocommerce_product($post_id, $post, $price) {
        ...
        if ($product_id) {
            ...
            // Log de succès
            error_log("HelvetiForma: Produit WooCommerce créé (ID: {$product_id}) pour l'article {$post_id}");
...
new HelvetiForma_Premium_Automation();
