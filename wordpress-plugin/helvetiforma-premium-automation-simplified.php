<?php
/**
 * Plugin Name: HelvetiForma Premium Automation (Simplified)
 * Description: Crée automatiquement des produits WooCommerce pour les articles premium - Version simplifiée
 * Version: 1.2.0
 * Author: HelvetiForma
 */
...
class HelvetiForma_Premium_Automation_Simplified {
    ...
    public function init() {
        ...
        // Log de démarrage
        error_log('HelvetiForma Premium Automation: Plugin simplifié initialisé');
    }
    ...
    public function handle_post_save($post_id, $post, $update) {
        ...
        // Récupérer les métadonnées ACF directement depuis la base de données
        $access_level = get_post_meta($post_id, 'access_level', true);
        $price = get_post_meta($post_id, 'price', true);
        
        error_log("HelvetiForma: Métadonnées ACF - access_level: {$access_level}, price: {$price}");
...
new HelvetiForma_Premium_Automation_Simplified();
