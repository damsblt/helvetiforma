        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-8">
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="lg:col-span-2">
              <EditableContent
                fieldName="conceptBlendedLearningTitle"
                value={content.conceptBlendedLearningTitle}
                type="text"
                placeholder="Titre de la section apprentissage hybride"
                className="mb-6"
              >
                <h2 className="text-2xl font-semibold text-gray-900">
                  {content.conceptBlendedLearningTitle}
                </h2>
              </EditableContent>
              
              <div className="space-y-4">
                <EditableContent
                  fieldName="conceptBlendedLearningDescription"
                  value={content.conceptBlendedLearningDescription}
                  type="textarea"
                  placeholder="Description de l'approche hybride"
                  className="mb-4"
                >
                  <p className="text-lg text-gray-700 font-medium">
                    {content.conceptBlendedLearningDescription}
                  </p>
                </EditableContent>
