        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200 text-center transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">{content.feature1Title}</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200 text-center transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">{content.feature2Title}</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200 text-center transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">{content.feature3Title}</h3>
              <p className="text-gray-600">
