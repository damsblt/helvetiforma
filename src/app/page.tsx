  ...
  return (
    <div className="min-h-screen">
      ...
      {homePage?.content?.rendered ? (
        ...
        /* Helpful message when WordPress is empty */
        <div className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 max-w-2xl mx-auto">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">
                Contenu WordPress en attente
              </h2>
              <p className="text-blue-700 mb-4">
                Pour personnaliser cette page, connectez-vous à WordPress et ajoutez du contenu à la page "Accueil".
              </p>
              <a 
                href="https://api.helvetiforma.ch/wp-admin/post.php?post=17&action=edit" 
                target="_blank" 
